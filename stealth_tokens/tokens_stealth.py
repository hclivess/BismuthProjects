...
def encrypt_data(token_name, token_amount, operation, key_encoded):
...
if __name__ == "__main__":
    ...
    address_token_key_dict = address_token_key_generate(token_key=token_key_dict["name"], address=address)
    ...
    encrypted_data_make = encrypt_data(token_name="stest", token_amount="10000", operation="make", key_encoded=token_key_dict["key"])
    encrypted_data_move = encrypt_data(token_name="stest", token_amount="1", operation="move", key_encoded=token_key_dict["key"])
